...
@Component({
  selector: 'app-maintenance-eq',
  standalone: true,
  imports: [CommonModule,FormsModule],
  templateUrl: './maintenance-eq.component.html',
  styleUrl: './maintenance-eq.component.css'
})
export class MaintenanceEqComponent implements OnInit {
